    ...
    try {
      ...
      if (!validationResult.isAllowed) {
        toast({
          variant: 'default',
          title: 'Request Sent',
          description: "Your signup request has been sent to the admin for approval.",
        });
      ...
      <div className="flex-grow flex items-center justify-center">
        <Card className="w-full max-w-sm">
          <CardHeader>
            ...
            <CardDescription>
              Enter your information to create an account. If you are not on the approved list, your request will be sent for admin approval.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
