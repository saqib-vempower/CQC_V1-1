  ...
  <section id="home" className="relative overflow-hidden">
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 md:py-28">
      ...
      >
        ...
        <motion.div variants={fadeIn(0.15)} className="mt-12 md:mt-16">
          <div className="relative mx-auto max-w-6xl rounded-2xl border border-gray-200 bg-white shadow-xl">
            <div
              className="absolute -inset-1 rounded-3xl bg-gradient-to-br from-transparent via-indigo-200/40 to-blue-200/40 blur-xl"
              aria-hidden="true"
            />
            <div className="relative rounded-2xl overflow-hidden">
              <div className="h-10 w-full bg-gray-50 border-b border-gray-200 flex items-center gap-1 px-3">
              ...
              <div className="grid md:grid-cols-3 gap-6 p-6 bg-white">
                ...
                <div className="rounded-xl border border-gray-200 p-5">
                  <div className="flex items-center gap-2 text-sm font-semibold text-gray-800">
                    <Icon path={icons.mic} /> Transcript (Diarized)
                  </div>
                  <div className="mt-3 space-y-2 text-sm">
                    <div className="flex gap-2">
                      ...
                      <p className="text-gray-600 truncate">
                        Hi, this is Ana from North Uni admissions…
                      </p>
                    </div>
                    <div className="flex gap-2">
                      ...
                      <p className="text-gray-600 truncate">
                        I wanted to ask about scholarship deadlines…
                      </p>
                    </div>
                    <div className="flex gap-2">
                      <span className="px-2 py-0.5 rounded bg-blue-50 text-blue-700">
                      ...
                      <p className="text-gray-600 truncate">
                        Sure—one moment while I check that for you…
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-xl border border-gray-200 p-5">
                  <div className="flex items-center gap-2 text-sm font-semibold text-gray-800">
                    <Icon path={icons.chart} /> Objective Metrics
                  </div>
                  <ul className="mt-3 space-y-2 text-sm text-gray-600">
                    <li className="flex items-center gap-2">
                      <span className="w-2 h-2 rounded-full bg-emerald-400" />{' '}
                      Talk time: Agent 7m • Student 6m
                    </li>
                    <li className="flex items-center gap-2">
                    ...
                    <li className="flex items-center gap-2">
                      <span className="w-2 h-2 rounded-full bg-sky-400" /> Holds
                      (signposted): 1 × 38s
                    </li>
                    <li className="flex items-center gap-2">
                ...
                <div className="rounded-xl border border-gray-200 p-5">
                  <div className="flex items-center gap-2 text-sm font-semibold text-gray-800">
                    <Icon path={icons.table} /> Rubric Scores
                  </div>
                  <div className="mt-3 space-y-2 text-sm">
                    {[
                      'Opening (C1)',
