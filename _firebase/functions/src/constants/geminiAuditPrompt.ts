...
INSTRUCTIONS:
1) For EACH criterion C1..C10, evaluate the call and provide a score. The score should be an INTEGER from 0 to the 'Weight' of that criterion, reflecting its weighted score. Assume a raw evaluation is on a scale of 0-5, then calculate (raw_score / 5) * Weight and round to the nearest whole number.
